...
csv_file = '/Users/poornima/Desktop/Workspace/DA/Data/heart_dirty.csv'
...
# 1. Removing Rows where 'age' is greater than 120 and lesser than 17
...
# 2. Replacing values over 200 in 'trestbps' column with estimate of 131 (unrealistically high heart rates)
df.loc[df['trestbps'] > 200, 'trestbps'] = 131
print(df.to_string())


# 3. Removing Any Empty Rows Left with Empty Cells
df = df.dropna()
print(df.to_string())
